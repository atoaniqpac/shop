...
<x-slot name="action">
    <a href="{{ route('admin.subcategories.create') }}" class="btn-success">
        {{ __('New subcategory') }}
    </a>
</x-slot>
                    ...
                    <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 text-black dark:text-white">
                            <div class="flex items-center justify-around">
                                <a href="{{ route('admin.subcategories.edit', $subcategory) }}" class="btn-circle-primary">
    ...
    @else
        ...
        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div>
            <span class="font-medium">{{ __('Info alert!') }}</span> Aun no existen subcategorias registradas por favor registre algunas para visualizarlas.
            </div>
        </div>
